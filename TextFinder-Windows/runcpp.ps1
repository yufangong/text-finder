...
echo  "  **************************************************"
./cppClient.exe search ../testcases distributed 
pause
...
echo  "  **************************************************"
./cppClient.exe search ../testcases objects
pause
...
echo  "  ************************************************************"
./cppClient.exe search ../testcases distributed objects /O
pause
...
echo  "  ************************************************************"
./cppClient.exe search ../testcases distributed objects
pause
...
echo  "  result files only contain any these two keywords"
echo  "  ************************************************************"
./cppClient.exe search ../ iostream text /O
pause
...
echo  "result files must contain all these two keywords"
echo  "************************************************************"
./cppClient.exe search ../ iostream text
